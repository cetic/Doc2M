...
/**
 * This is the item provider adapter for a {@link simplekaos.Assignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssignmentItemProvider extends KAndOrRelItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assignment_goal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Assignment_goal_feature", "_UI_Assignment_type"),
				 SimplekaosPackage.Literals.ASSIGNMENT__GOAL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAssigneePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assignment_assignee_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Assignment_assignee_feature", "_UI_Assignment_type"),
				 SimplekaosPackage.Literals.ASSIGNMENT__ASSIGNEE,
				 true,
				 false,
				 true,
				 null,
