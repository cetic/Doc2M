...
/**
 * This is the item provider adapter for a {@link simplekaos.Conflict} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConflictItemProvider extends KRelationshipItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addBoundaryConditionPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Boundary Condition feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBoundaryConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conflict_BoundaryCondition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conflict_BoundaryCondition_feature", "_UI_Conflict_type"),
				 SimplekaosPackage.Literals.CONFLICT__BOUNDARY_CONDITION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimplekaosPackage.Literals.CONFLICT__GOAL,
				 true,
				 false,
				 true,
				 null,
