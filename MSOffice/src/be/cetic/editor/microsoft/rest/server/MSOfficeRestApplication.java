...
import be.cetic.editor.microsoft.rest.server.restlet.*;


public class MSOfficeRestApplication extends Application{
	...
	private static final Logger logger = Logger.getLogger(MSOfficeRestApplication.class.getName());
